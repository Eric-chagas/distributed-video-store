...
| **Catalogue Service (Microserviço 1)** | É a implementação do microsserviço **A**, que gerencia catálogo de vídeos | python gRPC server | Python |
...
| **Python** | Implementação do microserviço A | TODO |
